...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_blackpill_f411ce
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 168, 168, 200, 500 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 22, 7, -15}
...
#define XY_PROBE_FEEDRATE (1500)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (500)
